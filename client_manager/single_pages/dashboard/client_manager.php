...
<div class="ccm-dashboard-header-buttons">
	<a href="/dashboard/client_manager" class="btn btn-primary"><i class="fa fa-newspaper-o"></i> Add New</a>
</div>
		...
		<form id="locationCallouts" name="locationCallouts" method="post" action="<?php if( isset($_GET['edit']) ){ echo $this->action('update'); } else { echo $this->action('save'); } ?>">
			...
			<div class="formElem">
				<label for="title">Title 
					<span>This sets the title text.</span>
				</label>
			...
			<div class="formElem">
				<label for="photo">Photo
					<span>This sets the logo asset (recommended size 170x177 pixels).</span>
				</label>
				<?php 				
			...
			<div class="formElem">
				<label for="sequence">Sequence
					<span>This sets the order in which this slide appears in the slider (currently not used).</span>
				</label>
